...
CartFullModel = rpart(formula = Annual_Sales ~ . , data = Mer_SalesTrainUncapped[,-1], method = "anova")  #method between regression tree and classification tree is done by anova.
CartFullModel 
